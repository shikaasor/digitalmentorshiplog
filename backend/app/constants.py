...
class ThematicArea:
    ...
    """
    GENERAL_HIV_CARE = "General HIV care and treatment"
    ADVANCED_HIV_DISEASE = "Advanced HIV disease (AHD)"
    PEDIATRIC_HIV = "Pediatric HIV management"
    PMTCT = "PMTCT"
    TB_HIV = "TB/HIV"
    LABORATORY_SERVICES = "Laboratory services"
    PHARMACY_SUPPLY_CHAIN = "Pharmacy/supply chain"
    DATA_QUALITY = "Data quality and use"
    ...
    def choices(cls):
        return [
            cls.GENERAL_HIV_CARE,
            cls.ADVANCED_HIV_DISEASE,
            cls.PEDIATRIC_HIV,
            cls.PMTCT,
            cls.TB_HIV,
            cls.LABORATORY_SERVICES,
            cls.PHARMACY_SUPPLY_CHAIN,
            cls.DATA_QUALITY,
